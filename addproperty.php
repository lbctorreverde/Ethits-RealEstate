                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body shadow">
                                ...
                                <button role="button" class="edit-btn btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#exampleModalEdit">Edit</button>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content rounded-0">
                        <div class="modal-header">
                            <span class='col-11 modal-title text-center ms-4 fw-bold'>
                                Add Property
                            </span>
            ...
            <div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content rounded-0">
                        ...
                        <!-- <div class="modal-header">
                            <span class="text-center">Edit Property</span>
                        ...
                        <div class="modal-body">
                            <form action="signcode.php" method="POST" class="container-fluid d-flex flex-column justify-content-center align-content-center" id="signup-form" enctype="multipart/form-data">
                                ...
                                <div class="image-preview-container">
                                    ...
                                    <label for="file-upload">Upload Image</label>
                                    <input type="file" id="file-upload" accept="image/*" onchange="previewImage1(event);" />
                                </div>
                                <script>
                                    /**
                                     * Create an arrow function that will be called when an image is selected.
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <button type="submit" name="btn_registerAgent" class="btn btn-dark mb-2">Save</button>
                                    <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Close</button>
                                </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content rounded-0">
                        ...
                        <div class="container-fluid d-flex flex-row justify-content-center align-items-center">
                            ...
                            <button type="button" class="btn-delete-cnfrm btn btn-light mx-1" data-bs-dismiss="modal">No</button>
                        </div>
                    </div>
                </div>
            </div>
