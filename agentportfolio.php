...
<section class="container-fluid d-flex align-items-center " id="topsection">
    ...
    <div class="container-fluid">
        <div class="box" style="height:200px">
            <div class="toptext">
                <h1 class="agent-name">Buntasaburo Tarokizaemon</h1>
            ...
            <div class="container">
                <div class="row align-items-start">
                    <div class="col mb-3">
                        ...
                        <span>Batumbakal Real Estate (Replace with Agency)</span>
                    </div>
                    <div class="col text-end">
                        <i class="bi bi-envelope-at-fill me-2"></i>
                        <span>emailsample@email.com</span>
                    </div>
                </div>
                <div class="row align-items-end">
                    <div class="col">
                        <i class="bi bi-geo-alt-fill me-2"></i>
                        <span>Brgy. 214, Rivermaya City, Original Filipino Music</span>
                    </div>
                    <div class="col text-end">
                        <i class="bi bi-telephone-fill me-2"></i>
                        <span>0912345678</span>
                        <br>
                        <span>244 444 444</span>
                    </div>
                </div>
            </div>
        </div>
