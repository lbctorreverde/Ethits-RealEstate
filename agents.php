                    ...
                    <div class="agentcard row g-0 mt-2 shadow">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <form method="POST" action="agentC.php"  class="form-control" >
                                    <input type="hidden" id="hide" name="hide" value="<?php echo $row['Uniquekey']?>">
                                    <button type="submit" id="btn_hide" name="btn_hide"><?php echo $row['lastName'].", ".$row['firstName']." ".substr($row['midName'], 0, 1)."."?></button>
                                </form>
