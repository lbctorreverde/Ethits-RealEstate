                    ...
                    <div class="row g-0">
                        ...
                        <div class="col">
                            <div class="card-body container-fluid d-flex flex-column">
                                ...
                                <form method="POST" onsubmit="return confirm('Are you sure you want to Accept the Transaction')" action="propertycart.php" class="property-name-post d-flex form-control text-start">
                                    <input type="hidden" id="hide" name="hide" value="<?php echo $row['trans_ID'] ?>">
                                    <button type="submit" id="btn_Accept" name="btn_Accept" class="btn-reject btn">Accept</button>
                                    <button type="submit" id="btn_Cancel" name="btn_Cancel" class="btn-reject btn">Reject</button>
                                </form>
